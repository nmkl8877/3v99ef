...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "vc336"         # 用户名
UUID = "7357d8fa-bab9-4cca-8ade-dde15af20aa2"                     # UUID，留空则自动生成
PORT = 36953                   # Vmess端口，留空或0则自动生成
DOMAIN = "ac.ocxuio.ggff.net"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiODk2Yzg5YTI2NjJmZTdjNzllNzgzYjVhNGVlYTNjY2UiLCJ0IjoiZDZhZDAzNmItOTdhYy00OTljLTgzMTMtZDk1NTU1MjBkMTkyIiwicyI6Ik5UZG1aR1JsWldNdE1EZ3laaTAwWW1Ka0xXSTFZVGN0TmpNeVlURTFOVFF4TUdObSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
